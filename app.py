...
from visual_chatgpt.tools.text_to_image import TextToImageBC
from visual_chatgpt.tools.image_to_text import ImageCaptionBC, ImageQuestionAnswerBC
...
class ConversationBot:
    def __init__(self):
        ...
        self.t2i = TextToImageBC(device="cuda:0")
